...
export default class EducationButtons extends Component {
    ...
    render() {
        ...
        let saveClick = (
            <div>
                <button type="button" name="newEducation" className="btn newButton" value="newState" onClick={this.handleOnSubmit}>New</button>
        ...
        let saveNew = (
            <div>
                <button type="button" name="education" className="btn saveButton" value="save" onClick={this.handleOnSubmit}>Save</button>
            </div>
        );
